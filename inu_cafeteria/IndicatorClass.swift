...
let activityData = ActivityData(size: CGSize(width: 40, height: 40), message: "로딩 중...", messageFont: UIFont(name: "KoPubDotumPB", size:16)!, type: NVActivityIndicatorType.ballClipRotate , color: UIColor.white, padding: 0, displayTimeThreshold: 5, minimumDisplayTime: 0, backgroundColor: UIColor(red: 0/255, green: 0/255, blue: 0/255, alpha: 0.5), textColor: UIColor.white)
